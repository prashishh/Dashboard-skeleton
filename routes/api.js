...
// responds table data in json format
exports.tabledata2 = function(req, res) {
  var mysql = require('mysql');
  var output = [];
  ...
  res.writeHeader(200, {'Content-type': 'application/json'});
  connection.query('SELECT ' + req.body.tables.join(',') + ' FROM table2', function(err, rows, fields) {
...
// responds pie chart data in json format
exports.piedata = function(req, res) {
  var mysql = require('mysql');
  var output = [];
  ...
  res.writeHeader(200, {'Content-type': 'application/json'});
  connection.query('SELECT ' + req.body.tables.join(',') + ' FROM piechart', function(err, rows, fields) {
...
// responds bar chart data in json format
exports.bardata = function(req, res) {
  var mysql = require('mysql');
  var output = [];
